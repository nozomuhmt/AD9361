...
-- Date        : Wed May 28 13:56:34 2025
-- Host        : lc35648-VirtualBox running 64-bit Ubuntu 24.04.2 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/lc35648/hdl/projects/fmcomms2/zed/fmcomms2_zed.gen/sources_1/bd/system/ip/system_sys_ps7_0/system_sys_ps7_0_sim_netlist.vhdl
...
entity system_sys_ps7_0 is
  ...
  attribute X_CORE_INFO of system_sys_ps7_0 : entity is "processing_system7_v5_5_processing_system7,Vivado 2022.2";
...
architecture STRUCTURE of system_sys_ps7_0 is
  ...
  attribute X_INTERFACE_PARAMETER of DMA0_ACLK : signal is "XIL_INTERFACENAME DMA0_ACLK, ASSOCIATED_BUSIF DMA0_ACK:DMA0_REQ, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN system_sys_ps7_0_FCLK_CLK0, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of DMA0_DAREADY : signal is "xilinx.com:interface:axis:1.0 DMA0_ACK TREADY";
  attribute X_INTERFACE_PARAMETER of DMA0_DAREADY : signal is "XIL_INTERFACENAME DMA0_ACK, TDATA_NUM_BYTES 0, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 2, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 0, FREQ_HZ 100000000, PHASE 0.0, CLK_DOMAIN system_sys_ps7_0_FCLK_CLK0, LAYERED_METADATA undef, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of DMA0_DAVALID : signal is "xilinx.com:interface:axis:1.0 DMA0_ACK TVALID";
  attribute X_INTERFACE_INFO of DMA0_DRLAST : signal is "xilinx.com:interface:axis:1.0 DMA0_REQ TLAST";
  attribute X_INTERFACE_INFO of DMA0_DRREADY : signal is "xilinx.com:interface:axis:1.0 DMA0_REQ TREADY";
  attribute X_INTERFACE_INFO of DMA0_DRVALID : signal is "xilinx.com:interface:axis:1.0 DMA0_REQ TVALID";
  attribute X_INTERFACE_INFO of DMA1_ACLK : signal is "xilinx.com:signal:clock:1.0 DMA1_ACLK CLK";
  attribute X_INTERFACE_PARAMETER of DMA1_ACLK : signal is "XIL_INTERFACENAME DMA1_ACLK, ASSOCIATED_BUSIF DMA1_ACK:DMA1_REQ, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN system_sys_ps7_0_FCLK_CLK0, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of DMA1_DAREADY : signal is "xilinx.com:interface:axis:1.0 DMA1_ACK TREADY";
  attribute X_INTERFACE_PARAMETER of DMA1_DAREADY : signal is "XIL_INTERFACENAME DMA1_ACK, TDATA_NUM_BYTES 0, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 2, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 0, FREQ_HZ 100000000, PHASE 0.0, CLK_DOMAIN system_sys_ps7_0_FCLK_CLK0, LAYERED_METADATA undef, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of DMA1_DAVALID : signal is "xilinx.com:interface:axis:1.0 DMA1_ACK TVALID";
  attribute X_INTERFACE_INFO of DMA1_DRLAST : signal is "xilinx.com:interface:axis:1.0 DMA1_REQ TLAST";
  ...
  attribute X_INTERFACE_INFO of DMA2_ACLK : signal is "xilinx.com:signal:clock:1.0 DMA2_ACLK CLK";
  attribute X_INTERFACE_PARAMETER of DMA2_ACLK : signal is "XIL_INTERFACENAME DMA2_ACLK, ASSOCIATED_BUSIF DMA2_ACK:DMA2_REQ, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN system_sys_ps7_0_FCLK_CLK0, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of DMA2_DAREADY : signal is "xilinx.com:interface:axis:1.0 DMA2_ACK TREADY";
  attribute X_INTERFACE_PARAMETER of DMA2_DAREADY : signal is "XIL_INTERFACENAME DMA2_ACK, TDATA_NUM_BYTES 0, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 2, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 0, FREQ_HZ 100000000, PHASE 0.0, CLK_DOMAIN system_sys_ps7_0_FCLK_CLK0, LAYERED_METADATA undef, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of DMA2_DAVALID : signal is "xilinx.com:interface:axis:1.0 DMA2_ACK TVALID";
  attribute X_INTERFACE_INFO of DMA2_DRLAST : signal is "xilinx.com:interface:axis:1.0 DMA2_REQ TLAST";
  attribute X_INTERFACE_INFO of DMA2_DRREADY : signal is "xilinx.com:interface:axis:1.0 DMA2_REQ TREADY";
  attribute X_INTERFACE_INFO of DMA2_DRVALID : signal is "xilinx.com:interface:axis:1.0 DMA2_REQ TVALID";
  ...
  attribute X_INTERFACE_PARAMETER of S_AXI_HP0_ACLK : signal is "XIL_INTERFACENAME S_AXI_HP0_ACLK, ASSOCIATED_BUSIF S_AXI_HP0, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN system_sys_ps7_0_FCLK_CLK0, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_INFO of DMA0_DATYPE : signal is "xilinx.com:interface:axis:1.0 DMA0_ACK TUSER";
  attribute X_INTERFACE_INFO of DMA0_DRTYPE : signal is "xilinx.com:interface:axis:1.0 DMA0_REQ TUSER";
  attribute X_INTERFACE_PARAMETER of DMA0_DRTYPE : signal is "XIL_INTERFACENAME DMA0_REQ, TDATA_NUM_BYTES 0, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 2, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 1, FREQ_HZ 100000000, PHASE 0.0, CLK_DOMAIN system_sys_ps7_0_FCLK_CLK0, LAYERED_METADATA undef, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of DMA1_DATYPE : signal is "xilinx.com:interface:axis:1.0 DMA1_ACK TUSER";
  attribute X_INTERFACE_INFO of DMA1_DRTYPE : signal is "xilinx.com:interface:axis:1.0 DMA1_REQ TUSER";
  attribute X_INTERFACE_PARAMETER of DMA1_DRTYPE : signal is "XIL_INTERFACENAME DMA1_REQ, TDATA_NUM_BYTES 0, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 2, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 1, FREQ_HZ 100000000, PHASE 0.0, CLK_DOMAIN system_sys_ps7_0_FCLK_CLK0, LAYERED_METADATA undef, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of DMA2_DATYPE : signal is "xilinx.com:interface:axis:1.0 DMA2_ACK TUSER";
  attribute X_INTERFACE_INFO of DMA2_DRTYPE : signal is "xilinx.com:interface:axis:1.0 DMA2_REQ TUSER";
  attribute X_INTERFACE_PARAMETER of DMA2_DRTYPE : signal is "XIL_INTERFACENAME DMA2_REQ, TDATA_NUM_BYTES 0, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 2, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 1, FREQ_HZ 100000000, PHASE 0.0, CLK_DOMAIN system_sys_ps7_0_FCLK_CLK0, LAYERED_METADATA undef, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of IRQ_F2P : signal is "XIL_INTERFACENAME IRQ_F2P, SENSITIVITY LEVEL_HIGH:LEVEL_HIGH:LEVEL_HIGH:LEVEL_HIGH:LEVEL_HIGH:NULL:NULL:NULL:NULL:NULL:NULL:NULL:NULL:NULL:NULL:NULL, PortWidth 16";
