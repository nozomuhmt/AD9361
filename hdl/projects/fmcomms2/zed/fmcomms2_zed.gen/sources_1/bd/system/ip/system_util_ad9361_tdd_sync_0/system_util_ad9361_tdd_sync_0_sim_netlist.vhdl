...
--               /home/lc35648/hdl/projects/fmcomms2/zed/fmcomms2_zed.gen/sources_1/bd/system/ip/system_util_ad9361_tdd_sync_0/system_util_ad9361_tdd_sync_0_sim_netlist.vhdl
...
architecture STRUCTURE of system_util_ad9361_tdd_sync_0_util_pulse_gen is
  ...
  signal pulse_period_d : STD_LOGIC_VECTOR ( 7 to 7 );
  signal \pulse_period_d[7]_i_1_n_0\ : STD_LOGIC;
  signal pulse_period_read : STD_LOGIC_VECTOR ( 7 to 7 );
  signal \pulse_period_read[7]_i_1_n_0\ : STD_LOGIC;
...
\pulse_period_d[7]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FB08"
    )
        port map (
      I0 => pulse_period_read(7),
      I1 => \pulse_period_cnt_reg_n_0_[0]\,
      I2 => \pulse_period_cnt[0]_i_2_n_0\,
      I3 => pulse_period_d(7),
      O => \pulse_period_d[7]_i_1_n_0\
    );
\pulse_period_d_reg[7]\: unisim.vcomponents.FDSE
    generic map(
      INIT => '0'
    )
        port map (
      C => clk,
      CE => '1',
      D => \pulse_period_d[7]_i_1_n_0\,
      Q => pulse_period_d(7),
      S => \^p_0_in\
    );
\pulse_period_read[7]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"D"
    )
        port map (
      I0 => rstn,
      I1 => pulse_period_read(7),
...
entity system_util_ad9361_tdd_sync_0 is
  ...
  attribute X_CORE_INFO of system_util_ad9361_tdd_sync_0 : entity is "util_tdd_sync,Vivado 2022.2";
