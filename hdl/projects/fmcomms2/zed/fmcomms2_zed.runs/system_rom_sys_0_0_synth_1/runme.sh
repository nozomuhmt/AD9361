...
HD_PWD='/home/lc35648/hdl/projects/fmcomms2/zed/fmcomms2_zed.runs/system_rom_sys_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_rom_sys_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_rom_sys_0_0.tcl
